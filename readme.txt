...
To run the code, check that 'training' is False so that you can run the notebook from the top through to bottom and it will skip the model training procedure and load in the best model and run the evaluations. 